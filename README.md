# Metavesthq landing page

![Metavesthq](https://github.com/mearashadowfax/ScrewFast/assets/125820963/cdf299bd-414a-4a2d-baf0-d188bb4709c7)

Metavest is an innovative platform that transcends traditional real estate investment, empowering Africans to build wealth and secure their financial futures. By combining expert knowledge, cutting-edge technology, [Astro](https://astro.build/), [Tailwind CSS](https://tailwindcss.com/), and [Preline UI](https://preline.co/), a passion for self-investment, Metavest revolutionizes the way you approach property investment.
